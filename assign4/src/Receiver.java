...
public class Receiver {
    ...
    */
    ...
    public TCPSegment receivePacket(DatagramPacket packet) throws IOException {
        ...
        this.totalBytesOfDataReceived += segment.getLength();
    ...
    public boolean isChecksumCorrect(TCPSegment packet) {
        ...
        byte[] reserializedPacketArray = packet.serialize();
        TCPSegment reserializedPacket = new TCPSegment(reserializedPacketArray);
        short expectedChecksum = reserializedPacket.getChecksum();
        //System.out.println(receivedChecksum == expectedChecksum);
